...
class AdminUser(models.Model):
    ...
    last_login_at = models.DateTimeField(blank=True, null=True, db_column="lastLoginAt")
    last_login_ip = models.CharField(max_length=191, blank=True, null=True, db_column="lastLoginIp")
    failed_login_attempts = models.IntegerField(default=0, db_column="failedLoginAttempts")
    locked_until = models.DateTimeField(blank=True, null=True, db_column="lockedUntil")
    auth_version = models.IntegerField(default=0, db_column="authVersion")
    reset_token_hash = models.CharField(max_length=191, blank=True, null=True, db_column="resetTokenHash")
    reset_token_expires_at = models.DateTimeField(blank=True, null=True, db_column="resetTokenExpiresAt")
    created_at = models.DateTimeField(db_column="createdAt", auto_now_add=True)
    updated_at = models.DateTimeField(db_column="updatedAt", auto_now=True)
